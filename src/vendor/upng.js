...
var pako;
if (typeof module == "object") {module.exports = UPNG;}  window.UPNG = UPNG;
if (typeof require == "function") { try { pako = require("pako"); } catch (e) {} }
if (!pako && typeof window !== "undefined") { pako = window.pako; }
